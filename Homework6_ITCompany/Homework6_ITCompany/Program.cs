...
namespace Homework6_ITCompany
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            jobApplicants.Add(new Person("Alexandra", "Krylova", 22, 'F', new[] { "QA engineer", "automation" }));
            //jobApplicants.Add(new Person("Peter", "Rich", 19, 'M', new[] { "QA engineer" }));
            //jobApplicants.Add(new Person("Lev", "Pushkin", 28, 'M', new[] { "QA engineer" }));
